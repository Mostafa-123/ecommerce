                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="categories" value="{{$category->id}}" class="chk-category"
                                                    @if (in_array($category->id, explode(',', $filterCategories)))
                                                        checked
                                                    @endif
                                                >
                                                {{$category->name}}
                                            </span>
                                            <spa    n class="text-right float-end">
                                        ...
                                        @foreach ($brands as $brand)
                                            <li class="list-item">
                                                <span class="menu-link py-1">
                                                    ...
                                                    @if (in_array($brand->id, explode(',', $filterBrands)))
                                                        checked
                                                    @endif>
                                                    {{$brand->name}}
                                                </span>
                        ...
                        <div class="accordion-item mb-4">
                            ...
                            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                                ...
                                <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                                    data-slider-max="{{$max_products_price}}" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]"
                                    data-currency="$" />
                                ...
                                <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                    ...
                                    <div class="slide-split_media position-relative">
                                        <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                            <img loading="lazy" src="{{asset('website')}}/assets/images/shop/shop_banner3.jpg"
                    ...
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        ...
                        <div
                            ...
                            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                                style="margin-right: 25px" aria-label="Page Size" id="pagesize" name="pagesize">
                            ...
                            <div class="product-card-wrapper">
                                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                        ...
                                        <div class="swiper-container background-img js-swiper-slider"
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                @foreach (explode(',', $product->images) as $image)
                                                    <div class="swiper-slide">
                                                        <a href="{{route('shop.product.details', ['product_slug' => $product->slug])}}"><img
                                                                loading="lazy" src="{{asset('uploads/products')}}/{{$image}}"
                                                                width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="pc__info position-relative">
                                        ...
                                        <form method="post"
                                         action="{{Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0 ?
                                         route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId]) : route('wishlist.add')}}">
                                            @csrf
                                            ...
                                            <button type="submit"
                                                ...
                                                title={{Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0 ? "Add To Wishlist" : "Remove from Wishlist"}}>
